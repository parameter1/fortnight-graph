...
module.exports = cleanEnv(process.env, {
  ...
  GA_TRACKING_ID: nonemptystr({ desc: 'The Google analytics ID that stories/sponsored content will use for tracking', default: 'UA-176756453-1' }),
  GA_VIEW_ID: nonemptystr({ desc: 'The Google analytics view ID that the API will use when querying data.', default: '227750442' }),
